...
class MainViewController: UIViewController, EZMicrophoneDelegate {
    ...
    // UI properties
    let plotToScreenRatio: CGFloat =  0.65
    ...
    func setupPlot() {
        plot = AKNodeOutputPlot(mic, frame: CGRect(x: 0, y: 0, width: audioInputPlot.frame.width, height: audioInputPlot.bounds.height*plotToScreenRatio) )
